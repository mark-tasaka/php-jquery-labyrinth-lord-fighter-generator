			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#fighterForm").attr('action', "character/ll_fighter_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
